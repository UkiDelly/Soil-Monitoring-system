...
CassaveModel _$CassaveModelFromJson(Map<String, dynamic> json) {
  return _CassaveModel.fromJson(json);
}
...
class _$_CassaveModel extends _CassaveModel {
  ...
  factory _$_CassaveModel.fromJson(Map<String, dynamic> json) =>
      _$$_CassaveModelFromJson(json);
...
abstract class _CassaveModel extends CassaveModel {
  ...
  factory _CassaveModel.fromJson(Map<String, dynamic> json) =
      _$_CassaveModel.fromJson;
